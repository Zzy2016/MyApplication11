...
import com.example.appkotlin.bean.Banner
import com.example.appkotlin.bean.BannerBean
import com.example.appkotlin.bean.BannerModel
...
class HomeViewModel : BaseViewModel() {
    ...
    fun getBanner() {
        ...
        Log.e("banner--->0", bannerModel.toString())

        mutableBanner.postValue(bannerModel)

        loadState.postValue(LoadState.SUCCESS)
//        var handler = Handler()
//        handler.postDelayed(Runnable { loadState.postValue(LoadState.SUCCESS) }, 1000)

        Log.e("banner--->1", bannerModel.toString())
    }
